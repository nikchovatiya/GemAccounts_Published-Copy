...
Public Class BAL_COMPANY
    ...
    Public Sub DIACRUD_GROUP(ByVal CTRL As DevExpress.XtraGrid.GridControl, ByVal diacmd As Integer, ByVal group_id As Integer, ByVal group_name As String, ByVal main_group_id As Integer, ByVal is_default As Boolean, ByVal under_group As Integer)
        ...
        VarCon.CloseConnection()
    End Sub
    Public Sub LedgerCRUD(ByVal CTRL As DevExpress.XtraGrid.GridControl, ByVal diacmd As Integer, ByVal LedgerID As Integer, ByVal CID As Integer, ByVal BID As Integer, ByVal UID As Integer, ByVal LedgerName As String, ByVal UnderGroup As Integer, ByVal Address As String, ByVal LCountry As String, ByVal State As String, ByVal City As String, ByVal Mobile As String, ByVal Phone As String, ByVal Email As String, ByVal GSTIN As String, ByVal PAN As String, ByVal Bank As String, ByVal AcNo As String, ByVal IFSC As String, ByVal Routing As String, ByVal Swift As String, ByVal OpeningBalance As Double)
        Try
            Dim CMD As New SqlCommand
            ...
            CMD.Parameters.AddWithValue("@LBID", BID)
            CMD.Parameters.AddWithValue("@LUID", UID)
            CMD.Parameters.AddWithValue("@LedgerName", LedgerName)
            CMD.Parameters.AddWithValue("@LUnderGroup", UnderGroup)
            CMD.Parameters.AddWithValue("@LAddress", Address)
            CMD.Parameters.AddWithValue("@LCountry", LCountry)
            CMD.Parameters.AddWithValue("@LState", State)
            CMD.Parameters.AddWithValue("@LCity", City)
            CMD.Parameters.AddWithValue("@LMobile", Mobile)
            CMD.Parameters.AddWithValue("@LPhone", Phone)
            CMD.Parameters.AddWithValue("@LEmail", Email)
            CMD.Parameters.AddWithValue("@LGSTIN", GSTIN)
            CMD.Parameters.AddWithValue("@LPAN", PAN)
            CMD.Parameters.AddWithValue("@LBank", Bank)
            CMD.Parameters.AddWithValue("@LAcNo", AcNo)
            CMD.Parameters.AddWithValue("@LBranch", AcNo)
            CMD.Parameters.AddWithValue("@LIFSC", IFSC)
            CMD.Parameters.AddWithValue("@LRouting", Routing)
            CMD.Parameters.AddWithValue("@LSwift", Swift)
            CMD.Parameters.AddWithValue("@LOpeningBalance", OpeningBalance)
    ...
    End Sub
    Public Sub GraderCRUD(ByVal CTRL As DevExpress.XtraGrid.GridControl, ByVal diacmd As Integer, ByVal GraderID As Integer, ByVal GraderName As String)
        Dim CMD As New SqlCommand
        CMD = New SqlCommand("GraderProcedure", VarCon.Connection)
        CMD.CommandType = CommandType.StoredProcedure
        CMD.Parameters.AddWithValue("@CMD", diacmd)
        CMD.Parameters.AddWithValue("@GraderID", GraderID)
        CMD.Parameters.AddWithValue("@GraderName", GraderName)
        ...
        VarCon.CloseConnection()
    End Sub
    Public Sub ProcessCRUD(ByVal CTRL As DevExpress.XtraGrid.GridControl, ByVal diacmd As Integer, ByVal ProcessID As Integer, ByVal ProcessName As String, ByVal DefaultLotStatus As Integer, ByVal DefaultItemType As Integer)
        Dim CMD As New SqlCommand
        CMD = New SqlCommand("ProcessProcedure", VarCon.Connection)
        CMD.CommandType = CommandType.StoredProcedure
        CMD.Parameters.AddWithValue("@CMD", diacmd)
        CMD.Parameters.AddWithValue("@ProcessID", ProcessID)
        CMD.Parameters.AddWithValue("@ProcessName", ProcessName)
        CMD.Parameters.AddWithValue("@DefaultLotStatus", DefaultLotStatus)
        CMD.Parameters.AddWithValue("@DefaultItemType", DefaultItemType)
        ...
        VarCon.CloseConnection()
    End Sub
    Public Sub GirdleCRUD(ByVal CTRL As DevExpress.XtraGrid.GridControl, ByVal diacmd As Integer, ByVal GirdleID As Integer, ByVal GirdleName As String, ByVal GirdleDesc As String, ByVal GirdleThin As String, ByVal GirdleThick As String)
        Dim CMD As New SqlCommand
        CMD = New SqlCommand("GirdleProcedure", VarCon.Connection)
        CMD.CommandType = CommandType.StoredProcedure
        CMD.Parameters.AddWithValue("@CMD", diacmd)
        CMD.Parameters.AddWithValue("@GirdleID", GirdleID)
        CMD.Parameters.AddWithValue("@GirdleName", GirdleName)
        CMD.Parameters.AddWithValue("@GirdleDesc", GirdleDesc)
        CMD.Parameters.AddWithValue("@GirdleThin", GirdleThin)
        CMD.Parameters.AddWithValue("@GirdleThick", GirdleThick)
        ...
        VarCon.CloseConnection()
    End Sub
    Public Sub GirdleConditionCRUD(ByVal CTRL As DevExpress.XtraGrid.GridControl, ByVal diacmd As Integer, ByVal GirdleConditionID As Integer, ByVal GirdleConditionName As String, ByVal GirdleConditionDesc As String)
        If GirdleConditionDesc = Nothing Then
            GirdleConditionDesc = String.Empty
        End If
        Dim CMD As New SqlCommand
        CMD = New SqlCommand("GirdleConditionProcedure", VarCon.Connection)
        CMD.CommandType = CommandType.StoredProcedure
        CMD.Parameters.AddWithValue("@CMD", diacmd)
        CMD.Parameters.AddWithValue("@GirdleConditionID", GirdleConditionID)
        CMD.Parameters.AddWithValue("@GirdleConditionName", GirdleConditionName)
        CMD.Parameters.AddWithValue("@GirdleConditionDesc", GirdleConditionDesc)
        ...
        VarCon.CloseConnection()
    End Sub
    Public Sub CuletCRUD(ByVal CTRL As DevExpress.XtraGrid.GridControl, ByVal diacmd As Integer, ByVal CuletID As Integer, ByVal CuletName As String, ByVal CuletDesc As String)
        If CuletDesc = Nothing Then
            CuletDesc = String.Empty
        End If
        Dim CMD As New SqlCommand
        CMD = New SqlCommand("CuletProcedure", VarCon.Connection)
        CMD.CommandType = CommandType.StoredProcedure
        CMD.Parameters.AddWithValue("@CMD", diacmd)
        CMD.Parameters.AddWithValue("@CuletID", CuletID)
        CMD.Parameters.AddWithValue("@CuletName", CuletName)
        CMD.Parameters.AddWithValue("@CuletDesc", CuletDesc)
